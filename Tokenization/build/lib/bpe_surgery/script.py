...
train_text = open(f'{dataset_path}/train_data.txt', 'r').read().splitlines()
train_lbls = [int(lbl) for lbl in open(f'{dataset_path}/train_labels.txt', 'r').read().splitlines()]
valid_text = open(f'{dataset_path}/valid_data.txt', 'r').read().splitlines()
valid_lbls = [int(lbl) for lbl in open(f'{dataset_path}/valid_labels.txt', 'r').read().splitlines()]
test_text = open(f'{dataset_path}/test_data.txt', 'r').read().splitlines()
test_lbls = [int(lbl) for lbl in open(f'{dataset_path}/test_labels.txt', 'r').read().splitlines()]
